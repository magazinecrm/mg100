import footerDataz from "@/data/siteFooterz";
import Link from "next/link";
import React from "react";
import { Container, Image } from "react-bootstrap";

const { logo, author, year, links, socials } = footerDataz;
        ...
        <Container>
          <div className="site-footer__5-col-wrap">
            ...
            <div className="footer-widget">
              <h3 className="footer-widget__title">Click on link below to check list of Switz  Magazine Publishers</h3>
